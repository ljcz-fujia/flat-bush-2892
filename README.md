...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/flat-bush-2892
```

A live public deployment of this template is available at [https://flat-bush-2892.templates.workers.dev](https://flat-bush-2892.templates.workers.dev)
